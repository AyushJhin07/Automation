...
interface RightInspectorPanelProps {
  ...
  nodeRequiresConnection: (node: Node) => boolean;
  credentialsDraft: string;
  setCredentialsDraft: React.Dispatch<React.SetStateAction<string>>;
  openNodeConfigModal: (node: Node) => Promise<void> | void;
  connectorDefinitions?: ConnectorDefinitionMap | null;
  handleRefreshConnectorMetadata: () => void;
  connectorDefinitionsLoading: boolean;
  connectorDefinitionsError: Error | null | undefined;
}
...
const RightInspectorPanel: React.FC<RightInspectorPanelProps> = ({
  ...
  handleRefreshConnectorMetadata,
  connectorDefinitionsLoading,
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-4 shadow-sm">
          ...
          <div className="space-y-3">
            <Button
              ...
              onClick={(e) => {
                e.stopPropagation();
                if (selectedNode) void openNodeConfigModal(selectedNode);
              }}
