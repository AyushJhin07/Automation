...
// metadata helpers moved to shared utility
...
const GraphEditorContent = () => {
  ...
  const onAddNode = useCallback((nodeType: string, nodeData: any) => {
    ...
    const normalizedDataWithMetadata = {
      ...normalizedData,
      metadata: mergeMetadataShape(normalizedData.metadata, metadata),
      outputMetadata: mergeMetadataShape(normalizedData.outputMetadata, metadata),
    };
    const newNode: Node = {
