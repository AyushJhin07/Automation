    ...
    <div className="editor-shell">
      ...
      <aside className="right-pane">
        <RightInspectorPanel
          ...
          connectorDefinitions={connectorDefinitions}
          handleRefreshConnectorMetadata={handleRefreshConnectorMetadata}
          connectorDefinitionsLoading={connectorDefinitionsLoading}
          connectorDefinitionsError={connectorDefinitionsError}
        />
      </aside>
