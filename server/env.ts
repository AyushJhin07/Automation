...
export const env = {
  ...
  APPS_SCRIPT_DRY_RUN_INTERVAL_MS: Number.parseInt(process.env.APPS_SCRIPT_DRY_RUN_INTERVAL_MS ?? `${30 * 60 * 1000}`, 10),
  APPS_SCRIPT_DRY_RUN_ENVIRONMENT: process.env.APPS_SCRIPT_DRY_RUN_ENVIRONMENT ?? 'staging',
  APPS_SCRIPT_DRY_RUN_FIXTURES_DIR: process.env.APPS_SCRIPT_DRY_RUN_FIXTURES_DIR,
  APPS_SCRIPT_DRY_RUN_FILTERS: process.env.APPS_SCRIPT_DRY_RUN_FILTERS,
  APPS_SCRIPT_ROLLOUT_TRACKER_URL: process.env.APPS_SCRIPT_ROLLOUT_TRACKER_URL,
  APPS_SCRIPT_QA_ALERT_WEBHOOK: process.env.APPS_SCRIPT_QA_ALERT_WEBHOOK,
  APPS_SCRIPT_SUPPORT_ALERT_WEBHOOK: process.env.APPS_SCRIPT_SUPPORT_ALERT_WEBHOOK,
} as const;
